              ...
              <tbody className="divide-y -divide--clr-silver-v1">
                {record.map((data, index) => (
                  <tr key={index} className="-text--clr-silver-v1">
                    ...
                    <td className="p-3 text-sm -text--clr-silver-v1 whitespace-nowrap">
                      <span
                        className={`p-1.5 text-xs text-white bg-yellow-500 font-medium uppercase tracking-wider text-${
                          ...
                          data.transactionType === "credit"
                            ...
                            ? "yellow"
                            : "gray"
                        }-200 rounded-lg bg-opacity-50`}
                      >
                        {data.transactionType ? data.transactionType : "debit"}
                      </span>
                    </td>
                    <td className="p-3 text-sm -text--clr-silver-v1 whitespace-nowrap">
                      {data.remark ? data.remark : "None"}
                    </td>
                    <td className="p-3 text-sm -text--clr-silver-v1 whitespace-nowrap">
              ...
              >
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <div className="text-gray-500">
                    {formatTimestamp(data.date).split(" ")[0]}
                  </div>
                  <div>
                    <span
                      className={`p-1.5 text-xs font-medium uppercase tracking-wider text-${
                        data.transactionType === "credit"
                          ? "green"
                          : data.transactionType === "CREDIT"
                          ? "yellow"
