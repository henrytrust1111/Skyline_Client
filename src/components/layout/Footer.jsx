                    ...
                    <div className="flex flex-wrap mb-12 lg:mb-20 -mx-3 text-center lg:text-left">
                        <div className="w-full lg:w-1/5 px-3 mb-6 lg:mb-0">
                            <Link href="/" className="flex items-center font-bold text-2xl gap-3" legacyBehavior>
                                ...
                                <span className="hidden lg:flex">Skyline-finnce</span>
                            <span className="flex lg:hidden">Skyline-finnce</span>                          
                              </Link>
                        </div>
                        ...
                        <div className="w-full lg:w-1/5 px-3 mb-8 lg:mb-0">
                            ...
                            <p className="lg:text-lg text-blueGray-400">32577 Ruecker Forest, Suite 074,</p>
                        </div>
